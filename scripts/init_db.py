...
def seed_books_v1(db):
    ...
    books_data = [
        ...
        },
        {
            ...
            "author": "Лев Толстой",
            "year": 1877,
            "isbn": "978-5-17-982341-6"
        },
        {
            "title": "Преступление и наказание",
            "author": "Федор Достоевский",
            "year": 1866,
            "isbn": "978-5-389-01087-8"
        },
        {
            "title": "Братья Карамазовы",
            "author": "Федор Достоевский",
            "year": 1880,
            "isbn": "978-5-17-982342-3"
        },
        {
            "title": "Мастер и Маргарита",
            "author": "Михаил Булгаков",
            "year": 1967,
            "isbn": "978-5-17-982344-7"
        },
    ]
    ...
    db.commit()
    print(f"✓ Добавлено {len(books_data)} книг V1")
...
def seed_books_v2(db):
    ...
    # Получаем авторов
    tolstoy = db.query(Author).filter(Author.name.contains("Толстой")).first()
    dostoevsky = db.query(Author).filter(Author.name.contains("Достоевский")).first()
    bulgakov = db.query(Author).filter(Author.name.contains("Булгаков")).first()
    chekhov = db.query(Author).filter(Author.name.contains("Чехов")).first()
    pushkin = db.query(Author).filter(Author.name.contains("Пушкин")).first()
    ...
    books_data = [
        {
            "title": "Война и мир",
            "author_id": tolstoy.id if tolstoy else None,
            "year": 1869,
        ...
        },
        {
            ...
            "author_id": tolstoy.id if tolstoy else None,
            "year": 1877,
            "isbn": "978-5-17-098231-7",
            "pages": 864,
            "genre": "Роман"
        },
        {
            "title": "Преступление и наказание",
            "author_id": dostoevsky.id if dostoevsky else None,
            "year": 1866,
            "isbn": "978-5-389-01088-5",
            "pages": 671,
        ...
        },
        {
            ...
            "author_id": dostoevsky.id if dostoevsky else None,
            "year": 1869,
            "isbn": "978-5-17-982345-4",
            "pages": 640,
            "genre": "Роман"
        },
        {
            "title": "Мастер и Маргарита",
            "author_id": bulgakov.id if bulgakov else None,
            "year": 1967,
            "isbn": "978-5-17-982346-1",
            "pages": 480,
            "genre": "Фантастика"
        },
        {
            ...
            "author_id": bulgakov.id if bulgakov else None,
            "year": 1925,
            "isbn": "978-5-17-982347-8",
            "pages": 352,
            "genre": "Сатира"
        },
        {
            "title": "Вишневый сад",
            "author_id": chekhov.id if chekhov else None,
            "year": 1904,
            "isbn": "978-5-17-982348-5",
            "pages": 128,
            "genre": "Пьеса"
        },
        {
            "title": "Евгений Онегин",
            "author_id": pushkin.id if pushkin else None,
            "year": 1833,
            "isbn": "978-5-17-982349-2",
            "pages": 224,
            "genre": "Роман в стихах"
        },
        {
            "title": "1984",
            "author_id": orwell.id if orwell else None,
            "year": 1949,
        ...
        },
        {
            ...
            "author_id": rowling.id if rowling else None,
            "year": 1997,
        ...
        },
        {
            ...
            "author_id": hemingway.id if hemingway else None,
            "year": 1952,
    ...
    for book_data in books_data:
        if book_data["author_id"]:
            ...
            if not existing:
                book = BookV2(**book_data)
                db.add(book)
                added += 1
    
    db.commit()
    print(f"✓ Добавлено {added} книг V2")
